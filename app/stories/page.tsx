...
export default function StoriesPage() {
  ...
  return (
    <>
      <PageHero title="Stories" subtitle="Impact stories from patients, communities, and our team." breadcrumbs={[{ label: "Stories" }]} />
              ...
              <Card key={article.id} className="overflow-hidden hover:shadow-md transition-shadow">
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="text-xs text-muted-foreground">{new Date(article.date).toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" })}</span>
                  </div>
